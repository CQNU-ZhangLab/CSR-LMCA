...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='D:\data\mimic_cxr\images/',
                      help='the path to the directory containing the data.')
    parser.add_argument('--image_seg_dir', type=str, default='D:\data\mimic_cxr/resnet34_300\images300_seg/',
                       help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='data/jjj/updated_data.json',
                      help='the path to the directory containing the data.')  #D:\data\mimic_cxr/annotation.json
    ...
    parser.add_argument('--num_layers', type=int, default=5, help='the number of layers of Transformer.')
    parser.add_argument('--m_layer', type=int, default=1, help='mamba_layer')
    parser.add_argument('--dropout', type=float, default=0.35, help='the dropout rate of Transformer.')
    ...
    parser.add_argument('--num_expert', type=int, default=3, help='the number of expert.')
    ...
    parser.add_argument('--save_dir', type=str, default='F:\heatmap/', help='the patch to save the models.')
    ...
    parser.add_argument('--lr_ve', type=float, default=6e-5, help='the learning rate for the visual extractor.')
    parser.add_argument('--lr_ed', type=float, default=3e-5, help='the learning rate for the remaining parameters.')
    ...
    # Others
    parser.add_argument('--seed', type=int, default=20000107, help='.')
    parser.add_argument('--resume', type=str, help='whether to resume the training from existing checkpoints.')
    parser.add_argument('--load', type=str,default='output/model_best_0.142.pth', help='whether to load the pre-trained model.')
