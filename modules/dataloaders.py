...
from .datasets import IuxrayMultiImageDataset, MimiccxrSingleImageDataset, MimiccxrDualImageDataset
...
class R2DataLoader(DataLoader):
    def __init__(self, args, tokenizer, split, shuffle):
        ...
        elif self.dataset_name == 'mimic_cxr_2':
            self.dataset = MimiccxrDualImageDataset(self.args, self.tokenizer, self.split, transform=self.transform)
